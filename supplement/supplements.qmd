...
This improved parameter estimation (see Figure S3-5).
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S2.** Distributions of Drift Diffusion Model parameters for the Cued Attention Task using Kolmogorov-Smirnov estimation.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S3. ** Chain convergence for the Hierarchical Bayesion Drift Diffusion Model for the Cued Attention Task. Plots should resemble a 'fat, hairy catterpillar'.
pilot_traces_cueing
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S4.** Drift Diffusion parameter recovery for the Cued Attention Task comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S5.** Drift Diffusion parameter recovery for the Cued Attention Task comparing simulated and recovered accuracy rates.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S6.** Chain convergence for the Hierarchical Bayesion Drift Diffusion Model for the Change Detection Task. Plots should resemble a 'fat, hairy catterpillar'.
pilot_traces_change
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S7.** Drift Diffusion parameter recovery for the Change Detection Task comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S8.** Drift Diffusion parameter recovery for the Change Detection Task comparing simulated and recovered accuracy rates.
...
As can be seen in Figure S9 and Figure S10, we observed high agreement between observed and simulated RTs and accuracy rates.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S9.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S10.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates.
...
Figure S11 and Figure S12 show the model fit based on simulated data.
...
#| fig.height: 7
#| fig-cap: | 
#|   **Figure S11.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times across the standard, enhanced, and degraded condition.
study1_ssp_fit_rt
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S12.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates across the standard, enhanced, and degraded condition.
study1_ssp_fit_acc
```
...
Figure S13 and Figure S14 show the model fit based on simulated data.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S13.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
study2_ssp_fit_rt
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S14.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates.
study2_ssp_fit_acc
```
...
Figure S15 provides an overview of these correlations for attentional width, shrinking rate, interference, and, for illustrative purposes, the RT difference score.
...
Figure S16 and Figure S17 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 3 in the main text.
...
Figure S18 and Figure S19 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 4 in the main text.
...
Figure S20-S23 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 5 in the main text.
...
Figure S24 and Figure S25 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Figure 2 in the main text.
...
Figure S26 and Figure S27 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Figure 3 in the main text.
