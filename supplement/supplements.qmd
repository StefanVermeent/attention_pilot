...
We plotted the factor loadings of each factor in the Pilot against those in Study 1 to investigate their correspondence (See Figure S1).
...
#| fig.height: 7
#| fig-cap: | 
#|   **Figure S1.** Comparison of factor loadings of unpredictability items in the Pilot and Study 1. 
study1_efa_fig 
```
<br>
...
Specifically, boundary separation estimates for several participants ended up at an upper boundary of 10, indicating that they were not recovered well (see Figure S2).
...
This improved parameter estimation (see Figure S4).
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S2.** Distributions of Drift Diffusion Model parameters for the Cued Attention Task using Maximum likelihood estimation.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S3.** Distributions of Drift Diffusion Model parameters for the Cued Attention Task using Kolmogorov-Smirnov estimation.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S4. ** Chain convergence for the Hierarchical Bayesion Drift Diffusion Model for the Cued Attention Task. Plots should resemble a 'fat, hairy catterpillar'.
pilot_traces_cueing
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S5.** Drift Diffusion parameter recovery for the Cued Attention Task comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S6.** Drift Diffusion parameter recovery for the Cued Attention Task comparing simulated and recovered accuracy rates.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S7.** Chain convergence for the Hierarchical Bayesion Drift Diffusion Model for the Change Detection Task. Plots should resemble a 'fat, hairy catterpillar'.
pilot_traces_change
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S8.** Drift Diffusion parameter recovery for the Change Detection Task comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S9.** Drift Diffusion parameter recovery for the Change Detection Task comparing simulated and recovered accuracy rates.
...
As can be seen in Figure S10 and Figure S11, we observed high agreement between observed and simulated RTs and accuracy rates.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S10.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S11.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates.
...
Figure S12 and Figure S13 show the model fit based on simulated data.
...
#| fig.height: 7
#| fig-cap: | 
#|   **Figure S12.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times across the standard, enhanced, and degraded condition.
study1_ssp_fit_rt
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S13.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates across the standard, enhanced, and degraded condition.
study1_ssp_fit_acc
```
...
Figure S14 and Figure S15 show the model fit based on simulated data.
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S14.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered response times at the 25th, 50th and 75th percentile of response times.
study2_ssp_fit_rt
```
...
#| fig.width: 7
#| fig-cap: | 
#|   **Figure S15.** Drift Diffusion parameter recovery for the Flanker comparing simulated and recovered accuracy rates.
study2_ssp_fit_acc
```
...
Figure S16 provides an overview of these correlations for attentional width, shrinking rate, interference, and, for illustrative purposes, the RT difference score.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S16. **Within-person bivarate correlations between Flanker conditions in Study 2 for RT differences, attentional width, shrinking rate, and interference.
study1_ssp_cor_plot
```
...
Figure S17 and Figure S18 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 3 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S18.** Multiverse explained variance of each data cleaning decision belonging to the analyses reported in Table 3 in the main text. Panel A: Cued Attention Task. Panel B: Change Detection Task. Panel C: Flanker Task.
final_plot_S18 <- 
...
Figure S19 and Figure S20 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 4 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S20.** Multiverse explained variance of each data cleaning decision belonging to the analyses reported in Table 4 in the main text. Panel A: Analyses involving violence exposure (hypothesis-driven). Panel B: Analyses involving unpredictability (exploratory).
final_plot_S20 <- 
...
Figure S21-S24 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Table 5 in the main text.
...
#| include: false
#| echo: false
f24_p1 <- study1_expl_ssp_enh_variance_plot$rt_diff + labs(title = "RT difference", tag = "A", y = "", fill = "") 
f24_p2 <- study1_expl_ssp_enh_variance_plot$p_flanker + labs(title = "Perceptual input", y = "") + guides(fill = "none")
f24_p3 <- study1_expl_ssp_enh_variance_plot$interference_flanker + labs(title = "Interference", y = "") + guides(fill = "none")
f24_p4 <- study1_expl_ssp_enh_variance_plot$a_flanker + labs(title = "Boundary separation", y = "") + guides(fill = "none")
f24_p5 <- study1_expl_ssp_enh_variance_plot$t0_flanker + labs(title = "Non-decision time", y = "") + guides(fill = "none")

f24_p6 <- study1_expl_ssp_deg_variance_plot$rt_diff + labs(title = "RT difference", tag = "B", y = "") + guides(fill = "none") 
f24_p7 <- study1_expl_ssp_deg_variance_plot$p_flanker + labs(title = "Perceptual input", y = "") + guides(fill = "none")
f24_p8 <- study1_expl_ssp_deg_variance_plot$interference_flanker + labs(title = "Interference", y = "") + guides(fill = "none") 
f24_p9 <- study1_expl_ssp_deg_variance_plot$a_flanker + labs(title = "Boundary separation", y = "") + guides(fill = "none") 
f24_p10 <- study1_expl_ssp_deg_variance_plot$t0_flanker + labs(title = "Non-decision time", y = "") + guides(fill = "none") 
...
Figure S25 and Figure S26 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Figure 2 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S25.** Multiverse p-value distributions belonging to the associations between violence exposure with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 2 in the main text. 
(
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S26.** Multiverse explained variance of each data cleaning decision belonging to the associations between violence exposure with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 2 in the main text. 
(
...
Figure S27 and Figure S28 present *p*-distributions and the explained variance of each data cleaning decision in the variation in effect sizes for the results presented in Figure 3 in the main text.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S27.** Multiverse p-value distributions belonging to the associations between unpredictability with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 3 in the main text. 
(
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S28.** Multiverse explained variance of each data cleaning decision belonging to the associations between unpredictability with perceptual input and interference in the Pilot, Study 1, Study 2, and pooled across all studies, as reported in Figure 3 in the main text. 
(
