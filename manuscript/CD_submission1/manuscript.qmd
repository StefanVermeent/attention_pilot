...
All scripts, materials, and data supporting the results presented here are available on the article's GitHub repository (<https://anonymous.4open.science/r/CogDev_AnonLink>).
...
First, few studies in the adversity literature have measured performance differences on different attention tasks within the same individual [@fields_2021; @mezzacappa_2004; @mittal_2015].
Thus, it is unclear whether lowered inhibition is related to enhanced processing of peripheral information in people from adverse backgrounds.
...
We expected people with more violence exposure to be better at detecting peripheral stimuli and subtle changes, as a result of a more diffuse scope of attention.
