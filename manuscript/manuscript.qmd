...
Adaptation- and deficit-based perspectives are considered complimentary: for instance, adversity may impair some cognitive processes, yet enhance others.
...
First, few studies in the adversity literature have measured performance differences on different attention tasks within the same individual.
...
This multifinality means that lowered performance on inhibition tasks does not necessarily reflect inhibition difficulties.
...
These deviations are described in the amendment (<https://github.com/stefanvermeent/attention_project/tree/main/preregistrations/3_study2/preregistration_amendment.md>).
...
We explored bivariate correlations between two indicators of short-term mindsets (impulsivity and future orientation) and SSP parameters of the Flanker (for more information on the measures, see section 1 of the supplemental materials).

See Table SX for an overview of the correlations.
