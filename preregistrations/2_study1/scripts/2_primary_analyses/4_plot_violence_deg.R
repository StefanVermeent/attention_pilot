...
load(here("data", "2_study1", "primary_vio_results.Rdata"))
...
primary_vio_deg_fig <- 
  ...
  draw_plot(
    plot_grid(
      spec_curves_vio_deg[[1]]$int,
      spec_curves_vio_deg[[1]]$eff_curve,
      spec_curves_vio_deg[[1]]$p_curve,
      spec_curves_vio_deg[[1]]$sample_sizes,
      spec_curves_vio_deg[[1]]$spec_grid,
      nrow  = 5,
      ncol  = 1, 
      align = "v", 
      axis  = "lr",
      rel_heights = c(.3,.3,.1,.1,.2)
    ) +
