...
primary_vio_enh_fig <- 
  ...
  draw_plot(
    plot_grid(
      spec_curves_vio_enh[[1]]$int,
      spec_curves_vio_enh[[1]]$eff_curve,
      spec_curves_vio_enh[[1]]$p_curve,
      spec_curves_vio_enh[[1]]$sample_sizes,
      spec_curves_vio_enh[[1]]$spec_grid,
      nrow  = 5,
      ncol  = 1, 
      align = "v", 
      axis  = "lr",
