...
var flanker_test_procedure_enhanced = {
  timeline: [flanker_fixation, flanker_present_arrows],
  timeline_variables: [
{congruency: 'congruent', condition: 'enhanced', location: 'up', correct_response: 'left',      stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&larr;', target = '&larr;',   size = 45, padding = 5)},
{congruency: 'congruent', condition: 'enhanced', location: 'down', correct_response: 'left',    stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&larr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'up', correct_response: 'left',    stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&rarr;', target = '&larr;',   size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'down', correct_response: 'left',  stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&rarr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'congruent', condition: 'enhanced', location: 'up', correct_response: 'right',     stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&rarr;', target = '&rarr;',   size = 45, padding = 5)},
{congruency: 'congruent', condition: 'enhanced', location: 'down', correct_response: 'right',   stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&rarr;', target = '&rarr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'up', correct_response: 'right',   stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&larr;', target = '&rarr;',   size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'down', correct_response: 'right', stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&larr;', target = '&rarr;', size = 45, padding = 5)},
{congruency: 'congruent', condition: 'enhanced', location: 'up', correct_response: 'left',      stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&larr;', target = '&larr;',   size = 45, padding = 5)},
{congruency: 'congruent', condition: 'enhanced', location: 'down', correct_response: 'left',    stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&larr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'up', correct_response: 'left',    stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&rarr;', target = '&larr;',   size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'down', correct_response: 'left',  stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&rarr;', target = '&larr;', size = 45, padding = 5)},
