...
var flanker_instructions = {
  ...
  //Page 7
   ...
   ".grid-item {" +
     ...
     "Decide if the <strong>middle arrow</strong> points LEFT (&larr;) or RIGHT (&rarr;).</p><br><br>" +
          "<div class='grid-container' style = 'height:400px';>" +
...
var flanker_practice_procedure_enhanced = {
  timeline: [flanker_fixation, flanker_practice, feedback],
  timeline_variables: [
{congruency: 'congruent',   condition: 'enhanced', location: 'up', correct_response: 'ArrowLeft',    practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&larr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'congruent',   condition: 'enhanced', location: 'down', correct_response: 'ArrowLeft',  practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&larr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'up', correct_response: 'ArrowLeft',    practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&rarr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'down', correct_response: 'ArrowLeft',  practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&rarr;', target = '&larr;', size = 45, padding = 5)},
{congruency: 'congruent',   condition: 'enhanced', location: 'up', correct_response: 'ArrowRight',   practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&rarr;', target = '&rarr;', size = 45, padding = 5)},
{congruency: 'congruent',   condition: 'enhanced', location: 'down', correct_response: 'ArrowRight', practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&rarr;', target = '&rarr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'up', correct_response: 'ArrowRight',   practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'up', flankers = '&larr;', target = '&rarr;', size = 45, padding = 5)},
{congruency: 'incongruent', condition: 'enhanced', location: 'down', correct_response: 'ArrowRight', practice_stim: set_arrows(angles = [0, 0, 0, 0, 0], loc = 'down', flankers = '&larr;', target = '&rarr;', size = 45, padding = 5)},
  ],
  randomize_order: true,
  repetitions: 1,
};
