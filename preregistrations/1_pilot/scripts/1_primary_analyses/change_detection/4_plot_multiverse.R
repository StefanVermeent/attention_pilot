...
primary_change_fig1 <- 
 ...
 # draw_label("Change Detection: Violence exposure main effect on raw scores", x = 0.6, y = .975, hjust = .5, vjust = 0, fontface = "bold")
...
save(primary_change_fig1, primary_change_fig2, file = here("preregistrations", "1_pilot", "presentations", "primary_figures_change.Rdata"))
