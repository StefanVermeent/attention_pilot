...
# Data
load(here("data", "1_pilot", "secondary_analyses", "change_detection", "1_multiverse_objects.Rdata"))
...
secondary_unp_change <- 
  ...
  future_map(function(x) {
    ...
    formula <- as.formula(str_glue("{dv} ~ unpredictability_composite_c"))
...
save(secondary_unp_change, file=here("data", "1_pilot", "secondary_analyses", "change_detection", "2_multiverse_results.Rdata"))
