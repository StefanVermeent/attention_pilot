...
load(here("data", "1_pilot", "2_secondary_analyses", "change_detection", "3_multiverse_extracted_effects.Rdata"))
...
secondary_change_fig1 <- 
  ...
  draw_label("Change Detection: Unpredictability main effect on raw scores", x = 0.6, y = .975, hjust = .5, vjust = 0, fontface = "bold")

secondary_change_fig2 <- 
  ggdraw() +
  draw_plot(
    plot_grid(
  ...
  draw_label("Change Detection: Unpredictability main effect on DDM parameters", x = 0.6, y = .975, hjust = .5, vjust = 0, fontface = "bold")

save(secondary_change_fig1, secondary_change_fig2, file = here("preregistrations", "1_pilot", "presentations", "secondary_figures_change.Rdata"))
